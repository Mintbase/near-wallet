...
const globalAlertReducer = handleActions({
    ...
    [combineActions(addAccessKey, addAccessKeySeedPhrase, setupRecoveryMessage, saveAndSelectLedgerAccounts, deleteRecoveryMethod, deployMultisig, removeAccessKey, signAndSendTransactions, addLedgerAccessKey, createAccountWithSeedPhrase)]: (state, { error, ready, payload, meta }) => ({
        ...state,
        globalAlert: ready ? {
            success: !error,
